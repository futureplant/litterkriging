# function that produces a confusion matrix for validation purposes ----
...
doValidation <- function(){
    ...
    predictions <- raster::extract(predicted,sampledata)
    
    # make a dataframe with predicted, measured and difference values
    ...
    # turn dataframe into confusion matrix
